...
public class RedGas extends Activity {
    private String codApi = "https://api.thingspeak.com/channels/237621/fields/7.json?api_key=JQ4UXUYWCX8SLO55&results=20";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_gas);
        lineChart = (LineChart) findViewById(R.id.red_chart);
        progressBar = (ProgressBar) findViewById(R.id.red_progress);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i<feeds.length();i++){
                        ...
                        Point p=new Point(new DateToTimestamp(s).getTimestamp(),Float.parseFloat(jo.getString("field7")));
    ...
    void createGraph(ArrayList<Point> p){
        ...
        LineDataSet dataSet = new LineDataSet(entries, "Reducing Gas");
