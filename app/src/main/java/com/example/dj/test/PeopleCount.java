...
public class PeopleCount extends Activity {
    private String PeepCountApi = "https://api.thingspeak.com/channels/237621/fields/1.json?api_key=JQ4UXUYWCX8SLO55&results=20";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lineChart = (LineChart) findViewById(R.id.peep_chart);
        progressBar = (ProgressBar) findViewById(R.id.peep_progress);
        lineChart.setVisibility(View.INVISIBLE);
        progressBar.setVisibility(View.VISIBLE);
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                PeepCountApi, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i<feeds.length();i++){
                        ...
                        Point p=new Point(new DateToTimestamp(s).getTimestamp(),Float.parseFloat(jo.getString("field1")));
    ...
    void createGraph(ArrayList<Point> p){
        ...
        MyMarkerView myMarkerView= new MyMarkerView(this.getApplicationContext(), R.layout.custom_marker,DateToTimestamp.ref,"People at");
